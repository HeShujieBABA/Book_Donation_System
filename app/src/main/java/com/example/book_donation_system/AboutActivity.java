...
public class AboutActivity extends AbsAboutActivity {
    ...
    protected void onItemsCreated(@NonNull Items items) {
        ...
        items.add(new Line());
        items.add(new Category("关于团队"));
        items.add(new License("更多惊喜", "图书捐赠", License.APACHE_2, "http://weibo.com/u/3263426514"));
        items.add(new License("关于我", "图书捐赠", License.APACHE_2, "http://weibo.com/u/3263426514"));
    }
}
